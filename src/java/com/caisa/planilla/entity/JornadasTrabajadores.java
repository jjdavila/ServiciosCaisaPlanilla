...
@NamedQueries({
    ...
    @NamedQuery(name = "JornadasTrabajadores.findByIdJornadasHoras", query = "SELECT j FROM JornadasTrabajadores j WHERE j.idJornadasHoras = :idJornadasHoras"),
    @NamedQuery(name = "JornadasTrabajadores.findByIdEmpleado", query = "SELECT j FROM JornadasTrabajadores j WHERE j.idEmpleado = :idEmpleado"),
    @NamedQuery(name = "JornadasTrabajadores.findByIdJornadas", query = "SELECT j FROM JornadasTrabajadores j WHERE j.idJornadas = :idJornadas"),
    @NamedQuery(name = "JornadasTrabajadores.findByHoraInicio", query = "SELECT j FROM JornadasTrabajadores j WHERE j.horaInicio = :horaInicio"),
    @NamedQuery(name = "JornadasTrabajadores.findByHoraSalidaAlmuerzo", query = "SELECT j FROM JornadasTrabajadores j WHERE j.horaSalidaAlmuerzo = :horaSalidaAlmuerzo"),
    @NamedQuery(name = "JornadasTrabajadores.findByHoraEntradaAlmuerzo", query = "SELECT j FROM JornadasTrabajadores j WHERE j.horaEntradaAlmuerzo = :horaEntradaAlmuerzo"),
    @NamedQuery(name = "JornadasTrabajadores.findByHoraSalida", query = "SELECT j FROM JornadasTrabajadores j WHERE j.horaSalida = :horaSalida"),
    @NamedQuery(name = "JornadasTrabajadores.findByFechaInicio", query = "SELECT j FROM JornadasTrabajadores j WHERE j.fechaInicio = :fechaInicio"),
    @NamedQuery(name = "JornadasTrabajadores.findByFechaFin", query = "SELECT j FROM JornadasTrabajadores j WHERE j.fechaFin = :fechaFin"),
    @NamedQuery(name = "JornadasTrabajadores.findByUsuario", query = "SELECT j FROM JornadasTrabajadores j WHERE j.usuario = :usuario")})
