...
@NamedQueries({
    ...
    @NamedQuery(name = "DeduccionesPorEmpleado.findByIdDEmpleado", query = "SELECT d FROM DeduccionesPorEmpleado d WHERE d.idDEmpleado = :idDEmpleado"),
    @NamedQuery(name = "DeduccionesPorEmpleado.findByNumeroEmpleado", query = "SELECT d FROM DeduccionesPorEmpleado d WHERE d.numeroEmpleado = :numeroEmpleado"),
    @NamedQuery(name = "DeduccionesPorEmpleado.findByIdDeduccionFija", query = "SELECT d FROM DeduccionesPorEmpleado d WHERE d.idDeduccionFija = :idDeduccionFija"),
    @NamedQuery(name = "DeduccionesPorEmpleado.findByIdDeduccionesOtro", query = "SELECT d FROM DeduccionesPorEmpleado d WHERE d.idDeduccionesOtro = :idDeduccionesOtro"),
    @NamedQuery(name = "DeduccionesPorEmpleado.findByIdFormula", query = "SELECT d FROM DeduccionesPorEmpleado d WHERE d.idFormula = :idFormula")})
