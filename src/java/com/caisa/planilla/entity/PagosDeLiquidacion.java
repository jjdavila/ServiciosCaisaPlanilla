...
@NamedQueries({
    ...
    @NamedQuery(name = "PagosDeLiquidacion.findByIdLiquidacion", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.idLiquidacion = :idLiquidacion"),
    @NamedQuery(name = "PagosDeLiquidacion.findByNumeroEmpleado", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.numeroEmpleado = :numeroEmpleado"),
    @NamedQuery(name = "PagosDeLiquidacion.findByFechaLiquidacion", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.fechaLiquidacion = :fechaLiquidacion"),
    @NamedQuery(name = "PagosDeLiquidacion.findByLiqPreaviso", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.liqPreaviso = :liqPreaviso"),
    @NamedQuery(name = "PagosDeLiquidacion.findByLiqInde", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.liqInde = :liqInde"),
    @NamedQuery(name = "PagosDeLiquidacion.findByLiqPrimaAntiguedad", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.liqPrimaAntiguedad = :liqPrimaAntiguedad"),
    @NamedQuery(name = "PagosDeLiquidacion.findByMis1", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.mis1 = :mis1"),
    @NamedQuery(name = "PagosDeLiquidacion.findByMis2", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.mis2 = :mis2"),
    @NamedQuery(name = "PagosDeLiquidacion.findByMis3", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.mis3 = :mis3"),
    @NamedQuery(name = "PagosDeLiquidacion.findByMis4", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.mis4 = :mis4"),
    @NamedQuery(name = "PagosDeLiquidacion.findByMis5", query = "SELECT p FROM PagosDeLiquidacion p WHERE p.mis5 = :mis5")})
