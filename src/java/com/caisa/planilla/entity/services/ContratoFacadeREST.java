...
public class ContratoFacadeREST extends AbstractFacade<Contrato> {
    ...
    @Override
    @Consumes({"application/xml", "application/json"})
    public void edit(Contrato entity) {
        super.edit(entity);
    }
    ...
    public Contrato find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<Contrato> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
