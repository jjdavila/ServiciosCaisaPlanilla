...
@NamedQueries({
    ...
    @NamedQuery(name = "CalendarioFeriado.findByIdFeriado", query = "SELECT c FROM CalendarioFeriado c WHERE c.idFeriado = :idFeriado"),
    @NamedQuery(name = "CalendarioFeriado.findByFechaDia", query = "SELECT c FROM CalendarioFeriado c WHERE c.fechaDia = :fechaDia"),
    @NamedQuery(name = "CalendarioFeriado.findByFechaMes", query = "SELECT c FROM CalendarioFeriado c WHERE c.fechaMes = :fechaMes"),
    @NamedQuery(name = "CalendarioFeriado.findByIdEstado", query = "SELECT c FROM CalendarioFeriado c WHERE c.idEstado = :idEstado"),
    @NamedQuery(name = "CalendarioFeriado.findByDescripcion", query = "SELECT c FROM CalendarioFeriado c WHERE c.descripcion = :descripcion")})
