...
@NamedQueries({
    ...
    @NamedQuery(name = "FormaDePago.findByIdFrmPago", query = "SELECT f FROM FormaDePago f WHERE f.idFrmPago = :idFrmPago"),
    @NamedQuery(name = "FormaDePago.findByFrmPago", query = "SELECT f FROM FormaDePago f WHERE f.frmPago = :frmPago")})
