...
@NamedQueries({
    ...
    @NamedQuery(name = "SiglasSistema.findByIdSiglas", query = "SELECT s FROM SiglasSistema s WHERE s.idSiglas = :idSiglas"),
    @NamedQuery(name = "SiglasSistema.findByNombreLargo", query = "SELECT s FROM SiglasSistema s WHERE s.nombreLargo = :nombreLargo"),
    @NamedQuery(name = "SiglasSistema.findBySiglas", query = "SELECT s FROM SiglasSistema s WHERE s.siglas = :siglas"),
    @NamedQuery(name = "SiglasSistema.findByApl", query = "SELECT s FROM SiglasSistema s WHERE s.apl = :apl")})
