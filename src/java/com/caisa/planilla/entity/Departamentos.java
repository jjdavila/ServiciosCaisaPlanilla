...
@NamedQueries({
    ...
    @NamedQuery(name = "Departamentos.findByIdFinca", query = "SELECT d FROM Departamentos d WHERE d.idFinca = :idFinca"),
    @NamedQuery(name = "Departamentos.findByIdEmpresa", query = "SELECT d FROM Departamentos d WHERE d.idEmpresa = :idEmpresa")})
public class Departamentos implements Serializable {
    ...
    public String toString() {
        return "com.caisa.planilla.entity.Departamentos[ idDepartamento=" + idDepartamento + " ]";
    }
