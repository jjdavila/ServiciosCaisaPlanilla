...
@NamedQueries({
    ...
    @NamedQuery(name = "IncapacidadesPorEmpleados.findByIdIncapacidades", query = "SELECT i FROM IncapacidadesPorEmpleados i WHERE i.idIncapacidades = :idIncapacidades"),
    @NamedQuery(name = "IncapacidadesPorEmpleados.findByNumeroEmpleado", query = "SELECT i FROM IncapacidadesPorEmpleados i WHERE i.numeroEmpleado = :numeroEmpleado"),
    @NamedQuery(name = "IncapacidadesPorEmpleados.findByFecha", query = "SELECT i FROM IncapacidadesPorEmpleados i WHERE i.fecha = :fecha"),
    @NamedQuery(name = "IncapacidadesPorEmpleados.findByMonto", query = "SELECT i FROM IncapacidadesPorEmpleados i WHERE i.monto = :monto"),
    @NamedQuery(name = "IncapacidadesPorEmpleados.findByHoras", query = "SELECT i FROM IncapacidadesPorEmpleados i WHERE i.horas = :horas")})
