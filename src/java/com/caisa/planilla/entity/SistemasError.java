...
@NamedQueries({
    ...
    @NamedQuery(name = "SistemasError.findByIdErroor", query = "SELECT s FROM SistemasError s WHERE s.idErroor = :idErroor"),
    @NamedQuery(name = "SistemasError.findByDescripcion", query = "SELECT s FROM SistemasError s WHERE s.descripcion = :descripcion"),
    @NamedQuery(name = "SistemasError.findByErrorFormateado", query = "SELECT s FROM SistemasError s WHERE s.errorFormateado = :errorFormateado")})
