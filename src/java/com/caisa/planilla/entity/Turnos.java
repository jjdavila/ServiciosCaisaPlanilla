...
@NamedQueries({
    ...
    @NamedQuery(name = "Turnos.findByHorafinal", query = "SELECT t FROM Turnos t WHERE t.horafinal = :horafinal"),
    @NamedQuery(name = "Turnos.findByPagoPorHora", query = "SELECT t FROM Turnos t WHERE t.pagoPorHora = :pagoPorHora"),
    @NamedQuery(name = "Turnos.findByTipoTurno", query = "SELECT t FROM Turnos t WHERE t.tipoTurno = :tipoTurno"),
    @NamedQuery(name = "Turnos.findByPagoExtraActivo", query = "SELECT t FROM Turnos t WHERE t.pagoExtraActivo = :pagoExtraActivo"),
    @NamedQuery(name = "Turnos.findByValorPagoExtra", query = "SELECT t FROM Turnos t WHERE t.valorPagoExtra = :valorPagoExtra"),
    @NamedQuery(name = "Turnos.findByValorPagoExtra2", query = "SELECT t FROM Turnos t WHERE t.valorPagoExtra2 = :valorPagoExtra2"),
    @NamedQuery(name = "Turnos.findByValorPagoExtra3", query = "SELECT t FROM Turnos t WHERE t.valorPagoExtra3 = :valorPagoExtra3"),
    @NamedQuery(name = "Turnos.findByPagoFeriadoActivo", query = "SELECT t FROM Turnos t WHERE t.pagoFeriadoActivo = :pagoFeriadoActivo"),
    @NamedQuery(name = "Turnos.findByValorPagoHraFeriado", query = "SELECT t FROM Turnos t WHERE t.valorPagoHraFeriado = :valorPagoHraFeriado"),
    @NamedQuery(name = "Turnos.findByHorasDia", query = "SELECT t FROM Turnos t WHERE t.horasDia = :horasDia"),
    @NamedQuery(name = "Turnos.findByIdActivo", query = "SELECT t FROM Turnos t WHERE t.idActivo = :idActivo"),
    @NamedQuery(name = "Turnos.findByUser", query = "SELECT t FROM Turnos t WHERE t.user = :user"),
    @NamedQuery(name = "Turnos.findByFechaCreacion", query = "SELECT t FROM Turnos t WHERE t.fechaCreacion = :fechaCreacion")})
