...
@NamedQueries({
    ...
    @NamedQuery(name = "PagosRegulares.findById", query = "SELECT p FROM PagosRegulares p WHERE p.id = :id"),
    @NamedQuery(name = "PagosRegulares.findByIdContrato", query = "SELECT p FROM PagosRegulares p WHERE p.idContrato = :idContrato"),
    @NamedQuery(name = "PagosRegulares.findByIdEmpleado", query = "SELECT p FROM PagosRegulares p WHERE p.idEmpleado = :idEmpleado"),
    @NamedQuery(name = "PagosRegulares.findByFecha", query = "SELECT p FROM PagosRegulares p WHERE p.fecha = :fecha"),
    @NamedQuery(name = "PagosRegulares.findByDeduccionesTotal", query = "SELECT p FROM PagosRegulares p WHERE p.deduccionesTotal = :deduccionesTotal"),
    @NamedQuery(name = "PagosRegulares.findByTotaBruto", query = "SELECT p FROM PagosRegulares p WHERE p.totaBruto = :totaBruto"),
    @NamedQuery(name = "PagosRegulares.findByTotalMano", query = "SELECT p FROM PagosRegulares p WHERE p.totalMano = :totalMano")})
