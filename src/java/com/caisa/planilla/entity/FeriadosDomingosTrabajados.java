...
@NamedQueries({
    ...
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByIdFeriados", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.idFeriados = :idFeriados"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByNumEmpleado", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.numEmpleado = :numEmpleado"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByFecha", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.fecha = :fecha"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByDescrpcionDia", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.descrpcionDia = :descrpcionDia"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByHoraEntrata", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.horaEntrata = :horaEntrata"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByHoraSalidaAlmuerzo", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.horaSalidaAlmuerzo = :horaSalidaAlmuerzo"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByHoraEntradaAlmuerzo", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.horaEntradaAlmuerzo = :horaEntradaAlmuerzo"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByHoraSalida", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.horaSalida = :horaSalida"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByBiatiaticos", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.biatiaticos = :biatiaticos"),
    @NamedQuery(name = "FeriadosDomingosTrabajados.findByHorasExtras", query = "SELECT f FROM FeriadosDomingosTrabajados f WHERE f.horasExtras = :horasExtras")})
