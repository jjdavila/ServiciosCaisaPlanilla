...
@NamedQueries({
    ...
    @NamedQuery(name = "TiposDeSangre.findByIdTpSangre", query = "SELECT t FROM TiposDeSangre t WHERE t.idTpSangre = :idTpSangre"),
    @NamedQuery(name = "TiposDeSangre.findByTpSangre", query = "SELECT t FROM TiposDeSangre t WHERE t.tpSangre = :tpSangre")})
